...
const StudyList: Array<IStudyList> = [
  {
    name: "피쿠닉",
    subtitle:
      "뚝섬유원지에서 즐기는 피크닉 딜리버리 서비스, 서버 구성 및 관리자 페이지 구축",
    icon: "/assets/study/pikunic.jpg",
    studys: [
      {
        title: "RESTful API 구축",
        subtitle:
          "안드로이드 앱 / WPF 응용프로그램 / React Web RESTful API 서버 구축",
        link: [
          {
            title: "카카오 플러스 친구",
            content: "https://pf.kakao.com/_yeVcj",
          },
          {
            title: "네이버 예약",
            content:
              "https://m.booking.naver.com/booking/6/bizes/233078?area=bbt&lang=ko",
          },
          {
            title: "GitHub",
            content: "https://github.com/PIKUNIC/pikunic-service-api",
          },
        ],
        mywork: [
          ...
          { title: "Database", content: "Server in database(MySQL)" },
          {
            ...
            content: "PM2(Advanced Node Js Process manager)",
          },
...

      {
        ...
        link: [
          {
            title: "참고 디자인",
            content: "http://admin.lightsinthesky.io/docs",
          },
          {
            title: "GitHub",
            content: "https://github.com/PIKUNIC/pikunic-admin-web",
          },
        ],
        mywork: [
          ...
          {
            title: "Server Build",
            content: "Web server(Ngnix), WAS(Node Js, HTTP), NCP",
          },
          { title: "Storage", content: "Object storage" },
        ],
      },
    ...
    studys: [
      {
        ...
        mywork: [
          {
            title: "Frontend",
            content: "React, Gatsby, JavaScript, Scss, Markdown",
          },
          {
            title: "Server Build",
            content: "Node Js, Netlify, Github webhook",
          },
    ...
    studys: [
      {
        ...
        mywork: [
          {
            title: "Frontend",
            content: "React, TypeScript, Scss, styled-components",
          },
...

  {
    name: "DEVLOG",
    subtitle:
      "github.io 도메인을 사용하여 다양한 정보를 공유하는 사이트를 제작",
    studys: [
      {
        link: [
          {
            title: "페이스북 링크",
            content:
              "https://www.facebook.com/groups/765872100510405/?ref=bookmarks",
          },
          {
            title: "카카오 링크",
            content: "https://open.kakao.com/o/gJcENvHb",
          },
          { title: "깃페이지 링크", content: "https://ljlm0402.github.io/" },
          {
            title: "GitHub",
            content: "https://github.com/ljlm0402/ljlm0402.github.io",
          },
        ],
        mywork: [
    ...
    studys: [
      {
        link: [
          {
            title: "GitHub",
            content: "https://github.com/ts-for-js/ts-express",
          },
        ],
        mywork: [
