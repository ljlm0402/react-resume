        ...
        studys: [
            {
                ...
                mywork: [
                    ...
                    { title: "트래픽 로드 밸런싱", content: "Pm2(Node.js Process manager)" },
...

            {
                ...
                mywork: [
                    { title: "React 구성", content: "draft.js(Editor Framework), babel(Javascript Compiler), grunt(Task Runner)" },
                    { title: "서버 구축", content: "웹 서버(Ngnix), WAS(Node.js, HTTP, HTTPS)" }
                ]
            }
        ]
    }
