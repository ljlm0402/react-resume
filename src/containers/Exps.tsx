...
const ExpList: Array<IExpList> = [
  {
    ...
    date: "2020. 03. 02 ~ 재직중",
    subtitle:
      "글로벌 통합보안 기업으로서 세계 수준의 기술력으로 개발한 솔루션과 전문적인 서비스 체계를 갖춘 기업 입니다.",
    ...
    project: [
      {
        ...
        mywork: [
          ...
          {
            title: "Database",
            content: "Postgresql(SQL), MogoDB(NoSQL), Redis",
          },
  ...
  },
  {
    ...
    subtitle:
      "단체음식을 배달 플랫폼 서비스를 하는 회사로써 홈페이지, 관리자 페이지, 등등 인프라 서비스를 구축하였습니다.",
    icon: "/assets/work/fooding.png",
    project: [
      {
        title: "푸딩, 홈페이지",
        subtitle: "메인 홈페이지 서비스 구축",
        link: [{ title: "푸딩 홈페이지", content: "https://www.fooding.io" }],
        ...
        mywork: [
          ...
          {
            title: "Server Build",
            content: "Web server(Nginx), WAS(Node Js, HTTP, HTTPS(ACM)), AWS",
          },
          ...
          { title: "Storage", content: "S3, CloudFront" },
          {
            ...
            content: "Docker, EC2, ECR, ECS",
          },
          {
            title: "CI / CD",
            content: "Github webhook, CodeBuild, CodePipeline",
          },
...

      {
        ...
        mywork: [
          ...
          {
            title: "Frontend",
            content: "Ionic, TypeScript, RxJs, Scss, Firebase",
          },
          {
            title: "Server Build",
            content: "Web server(Nginx), WAS(Node Js, HTTP, HTTPS(ACM)), AWS",
...

      {
        ...
        mywork: [
          ...
          {
            title: "Server Build",
            content: "WAS(Node Js, HTTP, HTTPS(ACM)), AWS",
          },
          { title: "Database", content: "RDS(MySQL)" },
          { title: "Load Balancing", content: "ALB, Route53" },
          { title: "Storage", content: "S3, CloudFront" },
...

  {
    ...
    subtitle:
      "외식 프랜차이즈 전문 솔루션 회사에서 무인주문결제기(KIOSK)를 개발하였습니다.",
    ...
    project: [
      {
        ...
        link: [
          {
            title: "씨큐프라임 홈페이지",
            content: "http://www.smartfranchise.co.kr/front/kiosk.php",
          },
          {
            title: "E-MODER KIOSK 구성도",
            content: "https://ljlm0402.wixsite.com/kiosk/",
          },
        ],
        ...
        mywork: [
          ...
          {
            title: "Frontend",
            content: "EJS(Embedded JavaScript templates), HTML, CSS, jQuery",
          },
          {
            title: "Server Build",
            content: "WAS(Node Js, HTTP), ASUS Tinker Board(ubuntu)",
          },
